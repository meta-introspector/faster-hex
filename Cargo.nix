...
let
  nixifiedLockHash = "2bae85b02d05c2e3d5cc6a34d164f03117e80d7c24b3814f983deafbb835c3f4";
...
in
{
  ...
  workspace = {
    faster-hex = rustPackages.unknown.faster-hex."0.10.0";
  };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".bitflags."1.3.2" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std") "default")
    ];
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".defmt."0.3.100" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std") "alloc")
    ];
    dependencies = {
      ${ if rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std" then "defmt10" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".defmt."1.0.1" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".defmt."1.0.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std" then "bitflags" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.3.2" { inherit profileName; }).out;
      ${ if rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std" then "defmt_macros" else null } = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".defmt-macros."1.0.1" { profileName = "__noProfile"; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".defmt-macros."1.0.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std" then "defmt_parser" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".defmt-parser."1.0.0" { inherit profileName; }).out;
      ${ if rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std" then "proc_macro_error2" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro-error2."2.0.1" { inherit profileName; }).out;
      ${ if rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std" then "proc_macro2" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.103" { inherit profileName; }).out;
      ${ if rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std" then "quote" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.42" { inherit profileName; }).out;
      ${ if rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std" then "syn" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."2.0.110" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".defmt-parser."1.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std" then "thiserror" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."2.0.17" { inherit profileName; }).out;
    };
  });
  ...
  "unknown".faster-hex."0.10.0" = overridableMkRustCrate (profileName: rec {
    name = "faster-hex";
    version = "0.10.0";
    registry = "unknown";
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std") "alloc")
      (lib.optional (rootFeatures' ? "faster-hex/default") "default")
      (lib.optional (rootFeatures' ? "faster-hex/defmt-03") "defmt-03")
      (lib.optional (rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/serde") "serde")
      (lib.optional (rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/std") "std")
    ];
    dependencies = {
      ${ if rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std" then "defmt" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".defmt."0.3.100" { inherit profileName; }).out;
    ...
    devDependencies = {
      ...
      rustc_hex = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-hex."1.0.0" { inherit profileName; }).out;
      serde = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.228" { inherit profileName; }).out;
      serde_json = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.145" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".proc-macro-error2."2.0.1" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std") "default")
      (lib.optional (rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std") "syn-error")
    ];
    dependencies = {
      ${ if rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std" then "proc_macro_error_attr2" else null } = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro-error-attr2."2.0.0" { profileName = "__noProfile"; }).out;
      ${ if rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std" then "proc_macro2" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.103" { inherit profileName; }).out;
      ${ if rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std" then "quote" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.42" { inherit profileName; }).out;
      ${ if rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std" then "syn" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."2.0.110" { inherit profileName; }).out;
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-hex."1.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-hex";
    version = "1.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "0ceb8ce7a5e520de349e1fa172baeba4a9e8d5ef06c47471863530bc4972ee1e"; };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".syn."2.0.110" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      ...
      [ "default" ]
      [ "derive" ]
      (lib.optional (rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std") "extra-traits")
      [ "full" ]
      [ "parsing" ]
      [ "printing" ]
      [ "proc-macro" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".thiserror."2.0.17" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std") "default")
      (lib.optional (rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std") "std")
    ];
    dependencies = {
      ${ if rootFeatures' ? "faster-hex/alloc" || rootFeatures' ? "faster-hex/default" || rootFeatures' ? "faster-hex/defmt-03" || rootFeatures' ? "faster-hex/serde" || rootFeatures' ? "faster-hex/std" then "thiserror_impl" else null } = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror-impl."2.0.17" { profileName = "__noProfile"; }).out;
    };
  });
